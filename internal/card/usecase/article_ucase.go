...
//func NewArticleUsecase(a models.ArticleRepository, ar models.AuthorRepository, timeout time.Duration) domain.ArticleUsecase {
func NewArticleUsecase(a models.ArticleRepository, timeout time.Duration) models.CardUsecase {
...
func (a *articleUsecase) Fetch(c context.Context, cursor string, num int64) (res []models.Card, nextCursor string, err error) {
	// if num == 0 {
	// 	num = 10
	// }
